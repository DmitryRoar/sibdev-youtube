import { OPEN_MODAL, CLOSE_MODAL, FAVORITE_SEARCH_VALUE, OPEN_MAIN_MODAL, CLOSE_MAIN_MODAL, CLEAR_MAIN_VALUE, ADD_ITEM, REMOVE_ITEM, EDIT_ITEM, CHANGE_MODAL_CLOSE, CHANGE_MODAL_OPEN } from "../actions/types"
